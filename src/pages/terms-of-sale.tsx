  ...
  return (
    <div className="max-w-2xl mx-auto prose prose-blue">
      ...
      <p>
        ...
        <a href="mailto:darkmatterbassmusic@gmail.com">
      ...
      <p>
        ...
        with photos of wrong/damaged items and we&apos;ll sort that out for
        you.
      </p>
      ...
      <p>
        ...
        and photos of the mislabeled item, and we&apos;ll send you a new one,
        or issue a refund!
      </p>
    </div>
  );
